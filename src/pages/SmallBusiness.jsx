  ...
  const content = (
    <div>
      ...
      <div id="features-container">
        ...
        <Lottie className="lottie right desktop-show" animationData={BespokeWebsite} />
          <div>
            <h1>Bespoke, premium website</h1>
            
            <p>
              This package includes a custom Wix website, tailored to your business and its needs.
              Even better, this website is fully customisable and you can change it yourself in the future.
              <br/><br/>
              Easily display your products/services, past work and anything else you could possibly imagine.
            </p>
            <div class="learn-more">
              <p>Learn more about this feature →</p>
            </div>
          </div>
          <Lottie className="lottie right stats-smallscreen" animationData={BespokeWebsite} />
        </section>
        <section className="pixelite-section left reveal">
          <div>
            ...
            <p>
              Wanting to promote your business? Or just want graphics to use on your social media? This package has your business covered.
              <br/><br/>
              Our team of professional designers will design <span class="pixelite-blue">2 Personalised Graphics</span> for your business with this package.
              These graphics are guaranteed to catch the attention of potential customers. Even better, you can choose the content of each graphic 
              so you can target your promotion to specific products.
        ...
        <section className="pixelite-section right reveal">
          <Lottie className="lottie right desktop-show" animationData={SEO_Optimisation} />
          <div>
            <h1>SEO Optimisation</h1>
            <p>
              Appearing high in search results is essential for the success of any business. That's why our team of specialist
              web developers will optimise the searchability of your website and boost reach so you can be sure you're reaching the most customers online. 
            </p>
            <div class="learn-more">
              <p>Learn more about this feature →</p>
            </div>
          </div>
          <Lottie className="lottie right stats-smallscreen" animationData={SEO_Optimisation} />
        </section>
        <section className="pixelite-section left reveal">
          <div>
            <h1>
            ...
            <p>
              Our <span class="pixelite-blue">'Ultimate guide to the digital landscape'</span> ebook is also included in this package. This product covers everything your business needs to know on how to 
              capitalise through digital channels. Covering SEO, promoting products, and social media management, this is a must-have guide for any business wanting to succeed in the 
              digital space.
            </p>
            <div class="learn-more">
              <p>Learn more about this feature →</p>
      ...
      <div class="pixelite-background">
      <div class="combined-heading">
        <h2>Testimonials</h2>
        <h1><span class="pixelite-white">What other businesses have said</span></h1>
      </div>
  ...
  return (
    <div>
      <PixelitePage
        ...
        mobileSubheader="You're in the right place. Starting at just £149, we provide everything your business could possibly need in the digital space."
      ></PixelitePage>
    </div>
  );
};
